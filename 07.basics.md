...
จะแค่พิมพ์ 'hello world' ก็ยังคงไม่พอ, ใช่ไหม? คุณต้องการทำมากกว่านั้น - คุณต้องการรับข้อมูลนำเข้า, ปรับปรุงข้อมูล และแสดงผลออกมา. เราสามารถทำสำเร็จได้ใน Python โดยใช้ค่าคงที่และตัวแปร, และเราจะเรียนรู้แนวคิดอื่นๆอีกในบนนี้.   

## Comments
##การเขียนคอมเม้นท์

_Comments_ are any text to the right of the `#` symbol and is mainly useful as notes for the reader of the program.
คอมเม้นท์  เป็นสายอักขระใดๆที่ตามหลังเครื่องหมาย '#'  และใช้ประโยชน์หลักๆ เพื่อการจดบันทึก สำหรับผู้ที่มาอ่านโปรแกรม 
...
print('hello world') # หมายเหตุ , print เป็นฟังก็ชัน
```
...
# # หมายเหตุ , print เป็นฟังก็ชัน
print('hello world')
```

Use as many useful comments as you can in your program to:
คุณใช้คอมเม้นท์มากเท่าไรก็ได้ในโปรแกรมเพื่อประโยชน์ดังต่อไปนี้: 

- explain assumptions
- อธิบาย สมมุติฐาน
- explain important decisions
- อธิบายการตัดสินใจที่สำคัญ
- explain important details
- อธิบายรายละเอียดที่สำคัญ 
- explain problems you're trying to solve
- อธิบายปัญหาที่คุณพยายามจะแก้ไข้ 
- explain problems you're trying to overcome in your program, etc.
- อธิบายปัญหาที่คุณกำลังพยายามเอาชนะให้ได้ , เป็นต้น 
...
ตัวอย่างของค่าคงที่ คือตัวเลข เช่น '5','1.23' , หรือ string(สายอักขระ) อย่างเช่น 'This is a string'` หรือ `"It's a string!"`.
...
มันถูกเรียกว่า literal เพราะว่ามันเป็น _literal_ - you use its value literally. The number `2` always represents itself and nothing else - มันเป็นค่าคงที่ เพราะว่าค่าของมันจะไม่สามารถเปลี่ยนได้, ดังนั้นทั้งหมดจะถูกอ้างถึงว่า literal constants.
...
ทุกๆ white space เช่น ช่องว่างและแท็บ, ที่อยู่ในโคต,จะยังคงจะยังคงถูกเก็บไว้เหมือนที่เห็น.

### Double Quotes

Strings in double quotes work exactly the same way as strings in single quotes. An example is `"What's your name?"`.
สตริงในดับเบิ้ลโคต ทำงานในแบบเดียวกับสตริงในโคตเดียว ทุกอย่าง. ตัวอย่างเช่น `"What's your name?"
...
Variables can hold values of different types called _data types_. The basic types are numbers and strings, which we have already discussed. In later chapters, we will see how to create our own types using [classes](./14.oop.md#classes).
...
1. Open [PyCharm](./06.first_steps.md#pycharm).
...
NOTE: Whenever you have to provide [command line arguments](./11.modules.md#modules), click on `Run` -> `Edit Configurations` and type the arguments in the `Script parameters:` section and click the `OK` button:
