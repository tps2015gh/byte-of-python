...
- `วิธีการแปลหนังสือเล่มนี้` ได้เพิ่ม Git Desktop กับ Markdown Editor ใน Windows และ MacOS   [24.translation_howto.md](https://github.com/gsong2014/byte-of-python/blob/master/24.translation_howto.md) ***เสร็จ : 3/12/2017***
