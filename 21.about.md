...
Almost all of the software that I have used in the creation of this book are [FLOSS](./20.floss.md#floss).
...
Initially, I was using KWord to write the book (as explained in the [history lesson](./22.revision_history.md#history-lesson)).
