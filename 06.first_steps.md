...
Open the terminal in your operating system (as discussed previously in the [Installation](./05.installation.md#installation) chapter) and then open the Python prompt by typing `python3` and pressing `[enter]` key.
...
1. Open a terminal window (see the previous [Installation](./05.installation.md#installation) chapter on how to do that)
